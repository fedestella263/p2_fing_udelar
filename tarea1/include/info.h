...
/*
 Devuelve un info_t cuyo dato numérico es la suma de los datos numéricos de
 `i1' e `i2', y cuyo frase es la concatenación de las frases
 de `i1' e `i2'.
 El elemento devuelto no comparte memoria con los parámetros.
 */
